    ...
    var Drawing = function () {
        ...
        _createClass(Drawing, [{
            ...
            value: function draw(oQRCode) {
                ...
                var _maskCanvas = void 0;
                var _mContext = void 0;
                ...
                for (var row = 0; row < nCount; row++) {
                    for (var col = 0; col < nCount; col++) {
                        ...
                        // let isBlkPosCtr = ((col < 8 && (row < 8 || row >= nCount - 8)) || (col >= nCount - 8 && row < 8) || (col < nCount - 4 && col >= nCount - 4 - 5 && row < nCount - 4 && row >= nCount - 4 - 5));
                        ...
                        for (var _i17 = 0; _i17 < agnPatternCenter.length - 1; _i17++) {
                            bProtected = bProtected || row >= agnPatternCenter[_i17] - 2 && row <= agnPatternCenter[_i17] + 2 && col >= agnPatternCenter[_i17] - 2 && col <= agnPatternCenter[_i17] + 2;
                        }
                ...
                for (var _i18 = 0; _i18 < agnPatternCenter.length; _i18++) {
                    for (var j = 0; j < agnPatternCenter.length; j++) {
                        var agnX = agnPatternCenter[j];
                        var agnY = agnPatternCenter[_i18];
                ...
                for (var _i19 = 0; _i19 < nCount - 8; _i19 += 2) {
                    _oContext.fillRect((8 + _i19) * nSize, 6 * nSize, nSize, nSize);
                    _oContext.fillRect(6 * nSize, (8 + _i19) * nSize, nSize, nSize);
                }
                for (var _i20 = 0; _i20 < agnPatternCenter.length; _i20++) {
                    for (var _j = 0; _j < agnPatternCenter.length; _j++) {
                        var _agnX = agnPatternCenter[_j];
                        var _agnY = agnPatternCenter[_i20];
                ...
                if (false && _htOption.binarize) {
                    ...
                    for (var _i21 = 0; _i21 < pixels.data.length; _i21 += 4) {
                        // rgb in [0, 255]
                        var R = pixels.data[_i21];
                        var G = pixels.data[_i21 + 1];
                        var B = pixels.data[_i21 + 2];
                        var sum = _greyscale(R, G, B);
                        if (sum > threshold) {
                            pixels.data[_i21] = 255;
                            pixels.data[_i21 + 1] = 255;
                            pixels.data[_i21 + 2] = 255;
                        } else {
                            pixels.data[_i21] = 0;
                            pixels.data[_i21 + 1] = 0;
                            pixels.data[_i21 + 2] = 0;
                        }
                    }
...
AwesomeQRCode.prototype.create = function (vOption) {
    ...
    try {
        ...
        if (vOption) {
            for (var _i22 in vOption) {
                this._htOption[_i22] = vOption[_i22];
            }
...
function _getTypeNumber(sText, nCorrectLevel) {
    ...
    for (var _i23 = 0, len = QRCodeLimitLength.length; _i23 <= len; _i23++) {
        var nLimit = 0;

        switch (nCorrectLevel) {
            case QRErrorCorrectLevel.L:
                nLimit = QRCodeLimitLength[_i23][0];
                break;
            case QRErrorCorrectLevel.M:
                nLimit = QRCodeLimitLength[_i23][1];
                break;
            case QRErrorCorrectLevel.Q:
                nLimit = QRCodeLimitLength[_i23][2];
                break;
            case QRErrorCorrectLevel.H:
                nLimit = QRCodeLimitLength[_i23][3];
                break;
        }
